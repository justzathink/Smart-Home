...
const Control = () =>{
    ...
    const [devices, setDevices] = useState([
        ...
        { id: "2", label: "Đèn 2", icon: icons.lightbulb },
        { id: "3", label: "Đèn 3", icon: icons.lightbulb },
        { id: "4", label: "Đèn 4", icon: icons.lightbulb },
        { id: "5", label: "Đèn 5", icon: icons.lightbulb },
        { id: "6", label: "Đèn 6", icon: icons.lightbulb }
    ]);
        ...
        <SafeAreaView className="px-6 bg-white h-full">
            ...
            <Modal 
                ...
                <View className="bg-white rounded-t-2xl p-6">
                    ...
                    <TouchableOpacity
                        className="bg-purple-700 py-3 rounded-xl items-center mb-2"
                        onPress={closeModal}
                    >
